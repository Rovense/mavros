...
Go to ~/catkin_ws/src and hit Ctrl+H to show hidden folder. 
Open .rosinstall.

Copy and paste below:

```
# THIS IS AN AUTOGENERATED FILE, LAST GENERATED USING wstool ON 2021-06-20
- git:
    local-name: mavlink
...
- git:
    local-name: mavros
    uri: https://github.com/Rovense/mavros.git
    version: build
